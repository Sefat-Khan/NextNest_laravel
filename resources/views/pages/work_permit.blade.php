...
@section('content')
    ...
    <section
        ...
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat filter"
            style="background-image: url('/images/website_cover.png')"></div>
        ...
        <div class="w-full h-full flex flex-col gap-2 justify-center items-center lg:items-start z-10 md:px-12">
            <a href="{{ route('work_permit') }}" class="text-[var(--secondary-color)] font-bold hover:text-white z-10"><i
                    class="fa-solid fa-angle-left"></i>Work Permit</a>

            <!-- Heading -->
            <h1 class="about-title opacity-0 relative text-[40px] sm:text-[50px] md:text-[65px] font-bold text-white z-10">
    ...
    <!--- study section --->
    <section class="relative pb-4 md:pb-8 lg:pb-16 pt-3 md:pt-6 lg:pt-12 px-8 text-center text-white bg-cover bg-no-repeat"
        ...
        <h2
            ...
            Collect Your Work Permit In This Country
        </h2>
        ...
        <div class="px-2 md:px-[4rem] 2xl:px-[8rem]">
            <div class="relative flex flex-col items-start lg:items-center glassy-bg clip-container">
                <div class="flex lg:flex-row flex-col-reverse items-center gap-0 card h-[400px] w-full">
                    <div
                ...
                including business, engineering, medicine, law, and the arts.
                    ...
                    <div
                        ...
                        <img src={{ asset('/images/canada.jpg') }} alt="canada" loading="lazy"
                            class="h-full w-full object-cover" />
                    </div>
                </div>
                <div class="flex lg:flex-row-reverse flex-col-reverse items-center gap-0 card h-[400px] w-full">
                    <div
                        class="lg:w-1/2 px-6 md:px-12 py-12 text-card text-center translate-x-[-50px] opacity-0 transition-all duration-500 ease-out">
                        <h4 class="text-[20px] md:text-[24px] lg:text-[27px] font-bold">
                            UK
                ...
                including business, engineering, medicine, law, and the arts.
                    ...
                    <div
                        class="lg:w-1/2 h-full image-card translate-x-[50px] opacity-0 transition-all duration-500 ease-out">
                        <img src={{ asset('/images/uk-blog.jpg') }} alt="canada" loading="lazy"
                            class="h-full w-full object-cover" />
                    </div>
                </div>
                <div class="flex lg:flex-row flex-col-reverse items-center gap-0 card h-[400px] w-full">
                ...
                including business, engineering, medicine, law, and the arts.
                    ...
                    <div
                        class="lg:w-1/2 h-full image-card translate-x-[50px] opacity-0 transition-all duration-500 ease-out">
                        <img src={{ asset('/images/UAE2.jpg') }} alt="canada" loading="lazy"
                            class="h-full w-full object-cover" />
                    </div>
                </div>
                <div class="flex lg:flex-row-reverse flex-col-reverse items-center gap-0 card h-[400px] w-full">
                ...
                including business, engineering, medicine, law, and the arts.
                    ...
                    <div
                        class="lg:w-1/2 h-full image-card translate-x-[50px] opacity-0 transition-all duration-500 ease-out">
                        <img src={{ asset('/images/spain.avif') }} alt="canada" loading="lazy"
                            class="h-full w-full object-cover" />
                    </div>
                </div>
                <div class="flex lg:flex-row flex-col-reverse items-center gap-0 card h-[400px] w-full">
                ...
                including business, engineering, medicine, law, and the arts.
                    ...
                    <div
                        class="lg:w-1/2 h-full image-card translate-x-[50px] opacity-0 transition-all duration-500 ease-out">
                        <img src={{ asset('/images/Portugal.webp') }} alt="canada" loading="lazy"
                            class="h-full w-full object-cover" />
                    </div>
                </div>
                <div class="flex lg:flex-row-reverse flex-col-reverse items-center gap-0 card h-[400px] w-full">
                ...
                including business, engineering, medicine, law, and the arts.
                    ...
                    <div
                        class="lg:w-1/2 h-full image-card translate-x-[50px] opacity-0 transition-all duration-500 ease-out">
                        <img src={{ asset('/images/denmark.jpg') }} alt="canada" loading="lazy"
                            class="h-full w-full object-cover" />
                    </div>
                </div>
            </div>
    ...
    <section class="text-center py-4 md:py-12 lg:py-20 px-4 text-white bg-white">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 px-8">
            ...
            <div
                class="bg-white rounded-xl overflow-hidden shadow-lg transition-transform transform scale-0 opacity-0 duration-500 hover:-translate-y-[10px] cursor-pointer">
                <div>
                    <img src={{ asset('images/banner-01.webp') }} alt="Malaysia" loading="lazy"
            ...
            <div
                class="bg-white rounded-xl overflow-hidden shadow-lg transition-transform transform scale-0 opacity-0 duration-500 hover:-translate-y-[10px] cursor-pointer">
                <div>
                    <img src={{ asset('images/banner-02.webp') }} alt="Malaysia" loading="lazy"
                        class="w-full h-auto object-cover" />
                </div>
                <div class="bg-[var(--secondary-color)] px-4 py-2 text-center mt-2">
                    <h3 class="text-[25px] font-bold text-white">MALAYSIA</h3>
            ...
            <div
                class="bg-white rounded-xl overflow-hidden shadow-lg transition-transform transform scale-0 opacity-0 duration-500 hover:-translate-y-[10px] cursor-pointer">
                <div>
                    <img src={{ asset('images/banner-03.webp') }} alt="Canada" loading="lazy"
                        class="w-full h-auto object-cover" />
                </div>
                <div class="bg-[var(--secondary-color)] px-4 py-2 text-center mt-2">
            ...
            <div
                class="bg-white rounded-xl overflow-hidden shadow-lg transition-transform transform scale-0 opacity-0 duration-500 hover:-translate-y-[10px] cursor-pointer">
                <div>
                    <img src={{ asset('images/banner-04.webp') }} alt="USA" loading="lazy"
                        class="w-full h-auto object-cover" />
                </div>
                <div class="bg-[var(--secondary-color)] px-4 py-2 text-center mt-2">
            ...
            <div
                class="bg-white rounded-xl overflow-hidden shadow-lg transition-transform transform scale-0 opacity-0 duration-500 hover:-translate-y-[10px] cursor-pointer">
                <div>
                    <img src={{ asset('images/banner-07.webp') }} alt="Australia" loading="lazy"
                        class="w-full h-auto object-cover" />
                </div>
                <div class="bg-[var(--secondary-color)] px-4 py-2 text-center mt-2">
            ...
            <div
                class="bg-white rounded-xl overflow-hidden shadow-lg transition-transform transform scale-0 opacity-0 duration-500 hover:-translate-y-[10px] cursor-pointer">
                <div>
                    <img src={{ asset('images/banner-05.webp') }} alt="UK" loading="lazy"
                        class="w-full h-auto object-cover" />
                </div>
                <div class="bg-[var(--secondary-color)] px-4 py-2 text-center mt-2">
            ...
            <div
                class="bg-white rounded-xl overflow-hidden shadow-lg transition-transform transform scale-0 opacity-0 duration-500 hover:-translate-y-[10px] cursor-pointer">
                <div>
                    <img src={{ asset('images/banner-06.webp') }} alt="Europe" loading="lazy"
                        class="w-full h-auto object-cover" />
                </div>
                <div class="bg-[var(--secondary-color)] px-4 py-2 text-center mt-2">
            ...
            <div
                class="bg-white rounded-xl overflow-hidden shadow-lg transition-transform transform scale-0 opacity-0 duration-500 hover:-translate-y-[10px] cursor-pointer">
                <div>
                    <img src={{ asset('images/banner-08.webp') }} alt="New Zealand" loading="lazy"
                        class="w-full h-auto object-cover" />
                </div>
                <div class="bg-[var(--secondary-color)] px-4 py-2 text-center mt-2">
